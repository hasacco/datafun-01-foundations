...
OBS:
  ...
  hasacco version is a copy - it can be edited
"""
...
# === DECLARE A GLOBAL VARIABLE TO HOLD A LIST OF FLOATS (SNOWFALL INCHES) ===
...
def main() -> None:
    ...
    # Create a horizontal boxplot to visualize the distribution of snowfall measurements.
    plt.boxplot(snowfall_inches, vert=False)
    plt.xlabel("Snowfall (inches)")
    plt.ylabel("Month")
    plt.title("Distribution of Snowfall Measurements")
    plt.show()
